...
-- Volcando estructura para procedimiento sig.add_inventario
DELIMITER //
CREATE PROCEDURE `add_inventario`(
IN `nom` varchar(50),
IN `des` int,
IN `tip` int,
IN `pr_cp` decimal(10,2),
IN `pr_vt` decimal(10,2),
IN `stk` int
)
BEGIN
insert into inventario (nombre,ID_desc,ID_tipo) values
(nom,des,tip);
set @id_iv = (SELECT MAX(iv.ID_inv) AS "ID" FROM inventario as iv);
insert into ganancia_perdida (ID_inv,precio_cp,cantidad_cp,inversion,precio_vt,cantidad_vd,ganancia, cant_min,reorden) values
(@id_iv,pr_cp,stk,(pr_cp*stk),pr_vt,0,0,200,0);
END//
DELIMITER ;
...
-- Volcando estructura para procedimiento sig.dell_venta
DELIMITER //
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED;

-- Volcando datos para la tabla sig.inventario: ~73 rows (aproximadamente)
/*!40000 ALTER TABLE `inventario` DISABLE KEYS */;
INSERT IGNORE INTO `inventario` (`ID_inv`, `nombre`, `ID_desc`, `ID_tipo`, `Imagen`) VALUES
	(1, 'Cola original', 101, 1, '../public/img/Productos/cola_original_lata.png'),
	(2, 'Cola original', 102, 1, '../public/img/Productos/cola_original_botella.png'),
	(3, 'Cola original', 103, 1, '../public/img/Productos/cola_original_botella.png'),
	(4, 'Cola original', 104, 1, '../public/img/Productos/cola_original_botella.png'),
	(5, 'Cola sin Azucar', 101, 1, '../public/img/Productos/cola_SinAzucar_lata.png'),
	(6, 'Cola Fresa', 101, 1, '../public/img/Productos/cola_fresa_lata.png'),
	(7, 'Cola Fresa', 102, 1, '../public/img/Productos/cola_fresa_botella.png'),
	(8, 'Cola Fresa', 103, 1, '../public/img/Productos/cola_fresa_botella.png'),
	(9, 'Cola Fresa', 104, 1, '../public/img/Productos/cola_fresa_botella.png'),
	(10, 'Cola Vainilla', 101, 1, '../public/img/Productos/cola_vainilla_lata.png'),
	(11, 'Cola Piña', 101, 1, '../public/img/Productos/fanta-piña_lata.png'),
	(12, 'Cola Piña', 102, 1, '../public/img/Productos/fanta-piña_botella.png'),
	(13, 'Cola Piña', 103, 1, '../public/img/Productos/fanta-piña_botella.png'),
	(14, 'Cola Piña', 104, 1, '../public/img/Productos/fanta-piña_botella.png'),
	(15, 'Cola Uva', 101, 1, NULL),
	(16, 'Cola Uva', 102, 1, NULL),
	(17, 'Cola Uva', 103, 1, NULL),
	(18, 'Cola Uva', 104, 1, NULL),
	(19, 'Cola Mandarina', 101, 1, NULL),
	(20, 'Cola Mandarina', 103, 1, NULL),
	(21, 'Cola de limón', 101, 1, NULL),
	(22, 'Cola de limón', 103, 1, NULL),
	(23, 'Cola de limón', 104, 1, NULL),
	(24, 'Agua', 201, 2, NULL),
	(25, 'Agua', 202, 2, NULL),
	(26, 'Agua', 203, 2, NULL),
	(27, 'Agua', 204, 2, NULL),
	(28, 'Agua', 205, 2, NULL),
	(29, 'Agua', 206, 2, NULL),
	(30, 'Jugo Piña', 301, 3, NULL),
	(31, 'Jugo Piña', 302, 3, NULL),
	(32, 'Jugo Piña', 303, 3, NULL),
	(33, 'Jugo Piña', 304, 3, NULL),
	(34, 'Jugo de Naranja', 301, 3, NULL),
	(35, 'Jugo de Naranja', 302, 3, NULL),
	(36, 'Jugo de Naranja', 303, 3, NULL),
	(37, 'Jugo de Naranja', 304, 3, NULL),
	(38, 'Jugo Mandarina', 301, 3, NULL),
	(39, 'Jugo Mandarina', 302, 3, NULL),
	(40, 'Jugo Mandarina', 303, 3, NULL),
	(41, 'Jugo Mandarina', 304, 3, NULL),
	(42, 'Jugo Verdura', 301, 3, NULL),
	(43, 'Jugo Verdura', 302, 3, NULL),
	(44, 'Jugo Verdura', 303, 3, NULL),
	(45, 'Jugo Verdura', 304, 3, NULL),
	(46, 'Jugo de Ponche', 301, 3, NULL),
	(47, 'Jugo de Ponche', 302, 3, NULL),
	(48, 'Jugo de Ponche', 303, 3, NULL),
	(49, 'Jugo de Ponche', 304, 3, NULL),
	(50, 'C', 401, 4, NULL),
	(51, 'C', 402, 4, NULL),
	(52, 'C', 403, 4, NULL),
	(53, 'C', 404, 4, NULL),
	...
	(64, 'ZING', 403, 4, NULL),
	(65, 'ZING', 404, 4, NULL),
	(66, 'MAGNECIO', 401, 4, NULL),
	(67, 'MAGNECIO', 402, 4, NULL),
	(68, 'MAGNECIO', 403, 4, NULL),
	(69, 'MAGNECIO', 404, 4, NULL),
	(70, 'COMPLEJO B', 401, 4, NULL),
	(71, 'COMPLEJO B', 402, 4, NULL),
	(72, 'COMPLEJO B', 403, 4, NULL),
	(73, 'COMPLEJO B', 404, 4, NULL);
...
-- Volcando estructura para vista sig.mostra_datosusuario
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `mostra_datosusuario` (
	`Imagen` VARCHAR(100) NULL COLLATE 'latin1_swedish_ci',
	`Id_user` INT(11) NOT NULL,
	`email` VARCHAR(50) NULL COLLATE 'utf8_general_ci',
	`celular` VARCHAR(50) NULL COLLATE 'utf8_general_ci',
	`tip_rol` VARCHAR(30) NOT NULL COLLATE 'utf8_unicode_ci',
...
CREATE TABLE `productos_emp` (
	...
	`precio_cp` DECIMAL(10,2) NULL,
	`reorden` INT(1) NULL,
	`Imagen` VARCHAR(100) NULL COLLATE 'utf8mb4_general_ci'
) ENGINE=MyISAM;
...
INSERT IGNORE INTO `sucursal` (`ID_sucursal`, `nombre_sucursal`, `perfil_sucursal`) VALUES
	...
	(3, 'Supermercado Extra', '../public/img/xtra.png'),
...
-- Volcando estructura para procedimiento sig.update_reorden
DELIMITER //
...
-- Volcando estructura para procedimiento sig.update_venta
DELIMITER //
...
INSERT IGNORE INTO `usuario` (`ID_user`, `pass`, `email`, `celular`, `token`, `ID_rol`, `ID_sucursal`, `ID_local_scr`, `ID_nombre`, `Image`) VALUES
	(1, '40001', 'manuelj@outlook.com', '63086641', '5fb0b28b94ee1', 1, 1, 1, 1, '../public/img/olivero.jpg'),
	(2, '40002', 'oliveiro20@outlook.com', '61274020', '5fb33184266b8', 2, 3, 8, 2, '../public/img/olivero.jpg'),
	(3, '40003', 'evelyn19@gmail.com', '62440076', '5faf60aa57151', 5, 2, 4, 3, '../public/img/evelyn.jpg'),
	(4, '40004', 'kevinsa18@gmail.com', '63069163', '5faf60ba016ae', 4, 4, 12, 4, '../public/img/olivero.jpg'),
	(5, '40005', 'domvairon15@outlook.com', '64161333', '5faf60cca11ab', 3, 2, 7, 5, '../public/img/olivero.jpg'),
	(6, '40006', 'arnoldo96@gmail.com', '66804618', '5faf60e2351ae', 3, 3, 9, 6, '../public/img/olivero.jpg'),
	(7, '40007', 'robert07@outlook.com', '6787290', NULL, 3, 2, 5, 7, NULL);
...
-- Volcando estructura para vista sig.mostra_datosusuario
-- Eliminando tabla temporal y crear estructura final de VIEW
DROP TABLE IF EXISTS `mostra_datosusuario`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `mostra_datosusuario` AS SELECT usuario.Image AS 'Imagen', usuario.Id_user, usuario.email, usuario.celular, r.tip_rol, s.nombre_sucursal, ls.ubicacion, nc.pri_nombre AS 'nombre', nc.pri_apellido AS 'apellido'
FROM usuario
